...
# 104 "main.c"
    ...
    while (1) {
        ...
        unsigned int key = read_switches(1);
        get_time();
        if (g == 7 && (key == 2 || key == 3)) {
            g = 2;
        } else if (key == 2 && g < 6) {
        ...
        switch (mode) {
            case 1:
                ...
                if (adc_reg_val < 100) {
                    clcd_putch('0' + (adc_reg_val / 10), (0xC0 + (13)));
                    clcd_putch('0' + (adc_reg_val % 10), (0xC0 + (14)));
                }
                ...
                if (p < 4) {
                    ...
                    if (strcmp(enter_password, password) == 0) {
                        ...
                        if (attempt > 1) {
                            ...
                            clcd_putch('0' + (count % 10), (0xC0 + (10)));
                            clcd_putch('0' + ((count / 10) % 10), (0xC0 + (9)));
                            clcd_putch('0' + ((count / 10) / 10), (0xC0 + (8)));
            ...
            case 3:
            {
                clcd_print(menu[m], (0x80 + (2)));

                clcd_print(menu[m + 1], (0xC0 + (2)));

                unsigned int key1 = read_switches(0);
            ...
            case 4:
            {
                ...
                char a = 0;
# 436 "main.c"
                unsigned int key2 = read_switches(0);
                ...
                clcd_putch(scv + 48, (0xC0 + (0)));
                clcd_putch(' ', (0xC0 + (1)));
                clcd_putch(event1, (0xC0 + (2)));
                clcd_putch(event2, (0xC0 + (3)));
                clcd_putch(':', (0xC0 + (4)));
                clcd_putch(event3, (0xC0 + (5)));
                clcd_putch(event4, (0xC0 + (6)));
                clcd_putch(':', (0xC0 + (7)));
                clcd_putch(event5, (0xC0 + (8)));
                clcd_putch(event6, (0xC0 + (9)));
                clcd_putch(' ', (0xC0 + (10)));
                clcd_putch(event7, (0xC0 + (11)));
                clcd_putch(event8, (0xC0 + (12)));
                clcd_putch(' ', (0xC0 + (13)));
                clcd_putch(event9, (0xC0 + (14)));
                clcd_putch(event10, (0xC0 + (15)));
           ...
           h1 = (hour & 0x0F);
              ...
              s1 = (seconds & 0x0F);
                ...
                if(delay1234++ <400)
                {
                     clcd_putch( '0'+(hour12%10), (0xC0 + (2)));
                clcd_putch('0'+ (hour12/10), (0xC0 + (1)));

                clcd_putch(':', (0xC0 + (3)));
                 clcd_putch('0'+(minutes12%10), (0xC0 + (5)));
                clcd_putch('0'+(minutes12/10), (0xC0 + (4)));
                clcd_putch(':', (0xC0 + (6)));
                 clcd_putch('0'+(seconds12%10), (0xC0 + (8)));
                clcd_putch('0'+(seconds12/10), (0xC0 + (7)));
                }
                ...
                unsigned int key3 = read_switches(0);
                if(key3!=255)
                {
                    time23++;
                    bsw=key3;
                    if(time23==1000)
                    {
                       ...
                       if(key3==5)
                       {
                           ...
                           write_ds1307(0x02,((hour12/10)<<4)| hour12%10);
                           write_ds1307(0x01,(( minutes12/10)<<4)| minutes12%10);
                           write_ds1307(0x00,((seconds12/10)<<4)| seconds12%10);
...
# 817 "main.c"
            ...
            case 8:
            {
                ...
                if (p1 < 4) {
                    ...
                    clcd_print("entr new password", (0x80 + (0)));
                    clcd_putch(' ', (0xC0 + (0)));
                    if (key == 5) {
                        enter_password1[p1] = '1';

                        clcd_putch('*', (0xC0 + (p1 + 4)));
                        p1++;
                ...
                else if(p2 < 4)
                    {
                        ...
                        clcd_print("re_entr new password", (0x80 + (0)));
                        clcd_putch(' ', (0xC0 + (0)));
                        if (key == 5) {
                            enter_password2[p2] = '1';

                            clcd_putch('*', (0xC0 + (p2 + 4)));
                            p2++;
